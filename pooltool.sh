...
COMMANDS:
    ...
    test-drives Test drive utilities module (temporary)
    test-visual Test drive visualizer module (temporary)  
    test-grid   Test grid rendering with different label types (temporary)
    test-debug  Debug dimension calculations for visualization (temporary)
...
EXAMPLES:
    ...
    drivemap                            # Show drive bay layout map (standalone)
